...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = os.environ.get('SOCIAL_AUTH_GOOGLE_OAUTH2_KEY', config('SOCIAL_AUTH_GOOGLE_OAUTH2_KEY', default=''))
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = os.environ.get('SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET', config('SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET', default=''))
